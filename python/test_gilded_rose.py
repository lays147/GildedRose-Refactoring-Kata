...
class GildedRoseTest(unittest.TestCase):
    ...
    def test_update_quality_case_six(self):
        """
        [One]
            Conditions:
        ...
        """
        items = [Item(name='Backstage passes to a TAFKAL80ETC concert', sell_in=15, quality = 40)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
        assert gilded_rose.items[0].quality is 41
    ...
    def test_update_quality_case_seven(self):
        """
        [One]
            Conditions:
                item name is Backstage
        ...
        Expected Result:
            ...
            item.name == Backstage passes to a TAFKAL80ETC concert
        """
        items = [Item(name='Backstage passes to a TAFKAL80ETC concert', sell_in=8, quality = 40)]
        gilded_rose = GildedRose(items)
        gilded_rose.update_quality()
    ...
    def test_update_quality_case_eight(self):
        """
        [One]
            Conditions:
                item name is Backstage
    ...
    def test_update_quality_case_nine(self):
        """
        [One] 
            Conditions:
                item name is not Aged Brie and is not Backstage
    ...
    def test_update_quality_case_ten(self):
        """
        [One] 
            Conditions:
                item name is not Aged Brie and is not Backstage
    ...
    def test_update_quality_case_eleven(self):
        """
        [One] 
            Conditions:
                item name is not Aged Brie and is not Backstage
    ...
    def test_update_quality_case_twelve(self):
        """
        [One]
            Conditions:
                item name is Backstage
    ...
    def test_update_quality_case_thirteen(self):
        """
        [One]
            Conditions:
                item name is Aged Brie
    ...
    def test_update_quality_case_fourteen(self):
        """
        [One]
            Conditions:
                item name is Aged Brie
